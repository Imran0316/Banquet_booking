    ...
    <nav class="navbar bg-white navbar-light">
        ...
        <div class="d-flex align-items-center ms-4 mb-4">
            <div class="position-relative">
                <img class="rounded-circle border border-3" src="<?php echo $owner_img; ?>" alt=""
                    style="width: 50px; height: 50px; object-fit:cover; border-color:#DAA520;">
                <div
            ...
            <div class="ms-3">
                ...
                <span class="badge rounded-pill"
                    style="background:linear-gradient(90deg,#800000,#DAA520);color:#fff;font-size:0.8rem;">Banquet
                    Owner</span>
            </div>
        </div>
        <div class="navbar-nav w-100">
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu bg-white border-0  rounded-3 py-2">
                    ...
                    <a href="manage_banquet.php?id=<?php echo $_SESSION['owner_id']; ?>" class="dropdown-item ps-5"
                        style="color:#800000;">
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu bg-white border-0  rounded-3 py-2">
                    ...
                    <a href="canceled_bookings.php?id=<?php echo $_SESSION['owner_id']; ?>" class="dropdown-item ps-5"
                        style="color:#800000;">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown" style="font-weight:500;">
                    <i class="bi bi-fork-knife" style="color:#DAA520;"></i>
                ...
                <div class="dropdown-menu bg-white border-0  rounded-3 py-2">
                    ...
                    <a href="canceled_bookings.php?id=<?php echo $_SESSION['owner_id']; ?>" class="dropdown-item ps-5"
                        style="color:#800000;">
                        <i class="bi bi-plus-circle-fill me-2" style="color:#DAA520;"></i>Add New
                    </a>
                </div>
            </div>
