        ...
        <div class="row g-4">
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="listed_banquets.php" class="text-white footer-link">Banquets</a></li>
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <div class="mt-2">
                    <a href="https://www.facebook.com/login/" target="_blank" class="text-white me-3 social-icon"><i
                            class="fab fa-facebook-f"></i></a>
                    <a href="https://instagram.com" target="_blank" class="text-white me-3 social-icon"><i
