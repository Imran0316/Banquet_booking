...
<div class="content">
    ...
    ?>
    <div class="booking_det px-5 pb-5 container mt-5">

        <!-- Left: Banquet Details -->
        <div class="banquet-details col-lg-8 col-12">

            <h3 class="mb-1 text-capitalize"><?php echo $banquet_data["name"]; ?> | Banquet</h3>
            <p class="text-muted mb-2"><i class="fa-solid fa-location-dot"></i>
                <?php echo $banquet_data["location"]; ?></p>
            <div class="mb-3">
                <span class="badge rounded-pill bg-warning">Wedding</span>
                <span class="badge rounded-pill bg-warning">Corporate</span>
                <span class="badge rounded-pill bg-warning">Birthday</span>
            </div>
            ...
            <div class="row  text-center my-4">
                <div class="col-md-4">
                    <div>
                        ...
                        <strong style="color: maroon;">Morning/Evening</strong>
                    </div>
                </div>
                <div class="col-md-4">
                    <div>
                        ...
                        <strong style="color: maroon;"><?php echo $banquet_data["capacity"]; ?></strong>
                    </div>
                </div>
                <div class="col-md-4">
                    <div>
                        ...
                        <strong style="color: maroon;">700 sq/ft</strong>
                    </div>
                </div>
            </div>
            ...
            <h5>Parking and Accessibility</h5>
            <div class="mb-3">
                <small> Parking lot or structure is available nearby </small><br>
                <small style="line-height: .5;"><strong>Access options:</strong> Stairs, Street Level.</small>
            </div>
             <div class="section-divider"></div>

            <h5>Features</h5>
            <div class="mb-3 d-flex align-items-start gap-4 flex-wrap">
                <ul>
                    <li><small>Free Wi-Fi</small></li>
                    <li><small>Air Conditioning</small></li>
                    <li><small>Sound System</small></li>
                    <li><small>On-site Catering</small></li>
                    
                </ul>
                <ul>
                    <li><small>Outdoor Seating Area</small></li>
                    <li><small>Wheelchair Accessible</small></li>
                    <li><small>Parking Available</small></li>
                    <li><small>Event Planning Services</small></li>
                </ul>
            </div>
            ...
            <h5>Opening Hours</h5>
            <div class="mb-3">
               <strong> Mon - Sun:</strong> <small> 09:00 AM - 11:00 PM</small>
            </div>
